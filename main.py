...
if menu == '1':
    ...
    while not (x == 0) :
        ...
        a_file.close()
    print('end')
    print('Token Gen From https://discord.gg/FVUQtRZ4nH')
    time.sleep(10)
    quit()
...
╚═╝┴└─┴ ┴ └┘ └─┘ ┴ ┴ ┴┴└──┴┘
    ...
    def SendWebhook(self,title,message,icon_url,thumbnail_url,proxy,useragent):
        try:
            ...
            message_to_send = {"embeds": [{"title": title,"description": message,"color": 65362,"author": {"name": "AUTHOR'S DISCORD SERVER [CLICK HERE]","url": "https://discord.gg/JXFHrZ9J9Y","icon_url": icon_url},"footer": {"text": "MADE BY ONEMANBUILDS","icon_url": icon_url},"thumbnail": {"url": thumbnail_url},"timestamp": timestamp}]}
